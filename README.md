...
| `blog.html` | Blog index (trending feature + cards) |
| `blog-*.html` | Six blog posts — generated by `docs/build_blog.py` (edit posts there, then run `python3 docs/build_blog.py <css v> <js v>` from the repo root) |
